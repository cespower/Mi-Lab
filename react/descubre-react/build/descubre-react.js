...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _helloExample = __webpack_require__(159);

	var _helloExample2 = _interopRequireDefault(_helloExample);

	var _messages = __webpack_require__(160);
	...
	var _todo = __webpack_require__(163);
	...
	var _count = __webpack_require__(167);

	var _count2 = _interopRequireDefault(_count);

	var _heroes = __webpack_require__(168);
	...
	var App = function (_React$Component) {
		...
		_createClass(App, [{
			...
			value: function render() {
				var url = 'http://soyjavi.com';

				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_helloExample2.default, { name: 'CesPowerMetal' }),
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_link2.default, { url: 'https://github.com/soyjavi', caption: 'My github' })
					),
					_react2.default.createElement('hr', null),
					_react2.default.createElement(_todo2.default, null),
					_react2.default.createElement('hr', null),
					_react2.default.createElement(_image2.default, { src: 'React-JS_logo.png', alt: 'Amazing Image' }),
					_react2.default.createElement('hr', null),
					_react2.default.createElement(_count2.default, { total: '0' }),
					_react2.default.createElement('hr', null),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Hello = function (_React$Component) {
		...
		_createClass(Hello, [{
			key: 'render',
			value: function render() {
				return _react2.default.DOM.h1({ className: 'mystyle' }, 'Hello ' + this.props.name + '!');
			}
		}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _helloExample = __webpack_require__(161);
		...
		_createClass(Messages, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_helloExample2.default, { name: 'CesarIn' })
				);
			}
		}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _tasks = __webpack_require__(164);

	var _tasks2 = _interopRequireDefault(_tasks);

	var _task = __webpack_require__(165);
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						_tasks2.default,
						null,
						_react2.default.createElement(_task2.default, { ref: 'first', name: 'Introduction', done: true }),
						_react2.default.createElement(_task2.default, { name: 'Chapter 1 - First component', done: true }),
						_react2.default.createElement(_task2.default, { name: 'Chapter 2 - Properties' }),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Count = function (_React$Component) {
		...
		function Count() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Count.__proto__ || Object.getPrototypeOf(Count)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
				count: _this.props.total
			}, _this.handleClick = function (event) {
				_this.setState({ count: parseInt(_this.state.count) + 1 });
			}, _temp), _possibleConstructorReturn(_this, _ret);
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var dataSource = [{ name: 'Superman', power: 'fly with underwear' }, { name: 'Batman', power: 'belt with gadgets' }, { name: 'Spiderman', power: 'Jump like a monkey' }, { name: 'Hulk', power: 'Angry with anyone' }];
	...
	var Heroes = function (_React$Component) {
		...
		function Heroes() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Heroes.__proto__ || Object.getPrototypeOf(Heroes)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
				list: []
